...
| 3 | [03-Capco-Document-Uploader-Service](03-Capco-Document-Uploader-Service/00-README.md) | Capco | Document Uploader-Ingest Service | REST APIs, FastAPI, SQLAlchemy ORM, RBAC with MSAL/OAuth, Docker, Azure App Service/Functions, Azure Key Vault, SQL, CRUD design |
