...
- **Fast, frequent iteration on LLM-backed services.** The chatbot assistant in course
  ...
  ingestion service referenced in course 03 (Document Uploader-Ingest Service) both change
...
deployment of the chatbot backend (course 01) and the document-uploader service (course 03).
...
- The **AI chatbot assistant** (course 01), the **model-risk-monitoring platform** (course 02), and
  the **document-uploader/ingest service** (course 03) all shipped through these pipelines to
...
model-risk-monitoring platform from course 02, or the FastAPI document-uploader service from course 03
