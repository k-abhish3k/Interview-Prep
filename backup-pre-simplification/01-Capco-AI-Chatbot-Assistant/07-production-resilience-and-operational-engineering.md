...
produced a visibly broken UI where two responses' tokens interleaved into the same message, because both
streams happened to still be in flight and briefly overlapped. The root cause was retrying at too coarse a
