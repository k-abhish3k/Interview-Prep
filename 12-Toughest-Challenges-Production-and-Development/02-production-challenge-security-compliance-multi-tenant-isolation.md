...
courses 1–6) and for **both Eli Lilly and AstraZeneca** (Indegene, courses 7–11). Any time one team
...
The Capco production stack described across courses 1–6 — Azure App Service behind Azure Front
...
- Any AI-generated claims content (e.g., from the GenAI Regulatory Platform in course 11, or claim
  extraction/tagging in course 9) needs a durable **audit trail**: what prompt/model version
