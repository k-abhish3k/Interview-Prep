...
function** applying SR 11-7-style governance (course 2). For the pharma engagements, that's
...
from course 2 — only against the accuracy/completeness metrics the engineering team had prioritized,
