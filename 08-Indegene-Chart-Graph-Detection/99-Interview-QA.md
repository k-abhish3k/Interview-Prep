...
the general behavioral warm-up, the same way course 03's real interview question leads its own Q&A.
...
version. **One honesty note up front, unlike course 03's Q1:** there's no source repository behind
...
- *"Would you say that's a gap, or was it never in scope?"* — Frame it like course 03's equivalent
...
- *"How would you prioritize building that versus other things?"* — Depends on how often documents are
  ...
  version stamping) described above, the same "quantify before prioritizing" answer course 03 gives for
