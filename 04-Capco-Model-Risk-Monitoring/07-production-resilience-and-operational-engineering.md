...
This chapter does for the monitoring platform what Course 05's chapter 06 does for the document
...
source repository backing this course, unlike Course 05. Treat the specific numbers, table rows, and bug
...
identical work. This is a lower-severity version of Course 05's not-a-singleton background-loop caveat
...
Presented in the same spirit as Course 05's four real bugs — concrete, specific, and structured around
...
- **Metrics-store database connection pool recycle: 1800 seconds (30 minutes).** The hourly aggregation
  ...
  low-traffic periods (mirroring exactly the reasoning Course 05 chapter 06 gives for its own
...
enough noise, at worst. The fix mirrors Course 05's session-secret fix exactly in shape: move the webhook
